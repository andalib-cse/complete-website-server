...
app.get('/', (req, res) => {
    res.send(`<h1>Girls Persona BD ==> Server is running...</h1>`);
})
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.sbgij.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
